 ...
 `);
    ...
    return (React.createElement(Box, { sx: {
        ...
        React.createElement(Box, { sx: {
            ...
            messages.map((message) => (React.createElement(MessageItem, { key: message.id, message: message, renderMarkdown: (text) => React.createElement(ReactMarkdown, null, text) }))),
        ...
        React.createElement(Paper, { elevation: 3, sx: {
            ...
            React.createElement(MessageInput, { newMessage: newMessage, setNewMessage: setNewMessage, handleSendMessage: handleSendMessage, toggleQuickPrompts: toggleQuickPrompts })),
        React.createElement(Drawer, { anchor: "bottom", open: quickPromptsOpen && isMobile, onClose: toggleQuickPrompts },
            React.createElement(Box, { sx: { p: 2, pt: 0 } },
                React.createElement(IconButton, { color: "primary", onClick: toggleQuickPrompts, sx: { float: 'right' } },
                    React.createElement(Close, null)),
                React.createElement(QuickPrompts, { onPromptClick: handleSendMessage }))),
        React.createElement(Drawer, { anchor: "right", open: quickPromptsOpen && !isMobile, onClose: toggleQuickPrompts },
            React.createElement(Box, { sx: { p: 2, width: 300, pt: '64px' } },
                React.createElement(IconButton, { color: "primary", onClick: toggleQuickPrompts, sx: { float: 'right' } },
                    React.createElement(Close, null)),
                React.createElement(QuickPrompts, { onPromptClick: handleSendMessage })))));
};
