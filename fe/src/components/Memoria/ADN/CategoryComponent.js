...
const CategoryComponent = ({ section, formData, expandedSections, handleChange, toggleSection, errors, editingField, handleEditField, handleSaveField, }) => {
